...
class NotificationsService : FirebaseMessagingService() {
    ...
    override fun onCreate() {
        super.onCreate()
        notificationLayout = RemoteViews(packageName, R.layout.notification_item_view) // Replace with your layout
    ...
    fun generateNotification(title : String, messageBody: String) {
        ...
        val notificationBuilder = NotificationCompat.Builder(applicationContext, Constants.CHANNEL_ID)
